...
import dev.turingcomplete.textcaseconverter.StandardWordsSplitters.STRICT_UPPER_CASE
...
class TextCasesExtensionsTest {
    ...
    fun testToTextCase() {
        ...
        assertThat("fooBar".toTextCase(SNAKE_CASE, STRICT_UPPER_CASE)).isEqualTo("foo_bar")
